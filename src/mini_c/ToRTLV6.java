		...
		public void visit(Eassign_local n) {
			...
			*/
			 ...
			 if(n.e instanceof Econst) {
				 current_graph.graph.put(L2, new Rconst(((Econst)n.e).i, r , Ld)); 
				 last_reg = r; 
				 last_result = L2; 
				 return; 
			 }
			 if(n.e instanceof Eaccess_local) {
				 ...
				 current_graph.graph.put(L2, new Rmbinop(Mbinop.Mmov,r2 ,r , Ld)); 
				 last_result = L2; 
				 last_reg = r; 
				 return; 
			 }
			 ...
			 //stack_reg.push(r2);
			 this.visit(n.e);
			 current_graph.graph.put(L2, new Rmbinop(Mbinop.Mmov,last_reg, r , Ld)); 
