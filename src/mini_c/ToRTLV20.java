...
/*
	 ...
	 public void visit(Ebinop n) {
		 ...
		 Mbinop m = null ;
		 //System.out.print(n.b == Binop.Bdiv); 
		 //.out.println( " ------------------------ "); 
		 if(n.b == Binop.Badd)
			 m = Mbinop.Madd ;
	...
	public void visit(Unop n) {
		...
		public void visit(Tint n) {
			...
			last_result = L1;
			System.out.println("Tint Fin"); 
		}

		public void visit(Tstructp n) {
			
			System.out.println("Tstructp Deb"); 
			Register rd = stack_reg.pop(); 
			Label Ld = stack_lab.pop(); 
			//Label Ld = new Label(); 
			Label L1 = new Label(); 
			...
			current_graph.graph.put(L1, new Rconst(0, rd, Ld)); 
			last_result = L1;
			System.out.println("Tstructp Fin"); 
		}
		...
		public void visit(Eunop n) {
			...
			if(n.u == Unop.Uneg) {
			 ...
			 current_graph.graph.put(L3, new Rmbinop(Mbinop.Msub, r2, rd, Ld)); 
				...
				//throw new Error("Unot !!!!!");
				 Ebinop la = new Ebinop(Binop.Bneq, n.e, new Econst(0)); 
				 Register rd = stack_reg.pop(); 
				 Label Ld = stack_lab.pop();
				 stack_reg.push(rd); 
				 stack_lab.push(Ld); 
