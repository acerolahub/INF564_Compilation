...
class ToLTL extends EmptyERTLERTLVisitor {
  ...
  public void visit(ERconst ertl) {
    ...
    graph.put(L, new Lconst(ertl.i, coloring.colors.get(ertl.r), ertl.l));
  ...
  public void visit(ERload ertl) {
    ...
    if (
      ...
      graph.put(
        L,
        new Lload(((Reg) coloring.colors.get(ertl.r1)).r, ertl.i, reg.r, temp)
      );
      graph.put(
        temp,
        new Lmbinop(Mbinop.Mmov, reg, coloring.colors.get(ertl.r2), ertl.l)
      );
    } else if (
      ...
      graph.put(
        L,
        new Lmbinop(Mbinop.Mmov, coloring.colors.get(ertl.r1), reg, temp)
      );
      graph.put(
        temp,
        new Lload(reg.r, ertl.i, ((Reg) coloring.colors.get(ertl.r2)).r, ertl.l)
      );
    } else {
      ...
      graph.put(temp, new Lload(reg.r, ertl.i, reg1.r, temp2));
      graph.put(
        temp2,
        new Lmbinop(Mbinop.Mmov, reg1, coloring.colors.get(ertl.r2), ertl.l)
      );
    }
  ...
  public void visit(ERstore ertl) {
    ...
    if (
      ...
      tmp_e = tmp_s;
      tmp_s = ertl.l; 
      graph.put(tmp_e, new Lload(Register.tmp1, ertl.i, ((Reg) coloring.colors.get(ertl.r2)).r, tmp_s));
      return; 
    }
  ...
  public void visit(ERmunop ertl) {
    ...
    Label L = stack_label.pop();
    graph.put(L, new Lmunop(ertl.m, coloring.colors.get(ertl.r), ertl.l));
  ...
  public void visit(ERmubranch ertl) {
    ...
    //graph.put(L, new Lcall(ertl.s, ertl.l)); 
    //if()
    graph.put(L, new Lmubranch(ertl.m, coloring.colors.get(ertl.r), ertl.l1, ertl.l2)); 
    if (debug) System.out.println("ERmubranch Fin");
  }
  public void visit(ERmbbranch ertl) {
    if (debug) System.out.println("ERmbbranch Deb");
    Label L = stack_label.pop();
    graph.put(L, new Lmbbranch(ertl.m, coloring.colors.get(ertl.r1), coloring.colors.get(ertl.r2), ertl.l1, ertl.l2)); 
    //graph.put(L, new Lcall(ertl.s, ertl.l)); 
  ...
  public void visit(ERpush_param ertl) {
    ...
    Label L = stack_label.pop();
    Operand tmp = coloring.colors.get(ertl.r); 
    if(tmp == null)
       tmp = new Reg(ertl.r); 
    graph.put(L, new Lpush(tmp, ertl.l) ); 
