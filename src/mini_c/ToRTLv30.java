	 ...
	 public Expr reduction(Expr nexpr) {
		...
		public void visit(Ebinop nbinop) {
			...
			if(temp instanceof Econst) {
				...
				if(n.b == Binop.Bge) m = Mbinop.Msetle;
				if(n.b == Binop.Bgt) m = Mbinop.Msetl; 
				if(n.b == Binop.Ble) m = Mbinop.Msetge;
				if(n.b == Binop.Blt) m = Mbinop.Msetg; 
				...
				if(n.e1 instanceof Econst && n.e2 instanceof Eaccess_local) {
					...
					if(n.b!=Binop.Band && n.b!=Binop.Bor) {
						if(n.b == Binop.Badd) um = new Maddi(((Econst)n.e1).i);
						...
						else if(n.b == Binop.Bdiv || n.b == Binop.Bmul || n.b == Binop.Bge || n.b == Binop.Bgt || n.b == Binop.Ble || n.b == Binop.Blt) {
							stack_reg.push(r2);
							this.visit(n.e1);
							stack_reg.push(rd);
							this.visit(n.e2);
							...
							if(n.b == Binop.Bdiv) {
								Label L5 = new Label();
								current_graph.graph.put(L3, new Rmbinop(m, rd, r2, L5));
								current_graph.graph.put(L5, new Rmbinop(Mbinop.Mmov, r2, rd, Ld));
							}
							/*
							else if(n.b == Binop.Bsub) {
								Label L5 = new Label();
								current_graph.graph.put(L3, new Rmbinop(m, rd, r2, L5));
								current_graph.graph.put(L5, new Rmbinop(Mbinop.Mmov, r2, rd, Ld));
							}
					...
					if(n.b!=Binop.Band && n.b!=Binop.Bor) {
						...
						stack_reg.push(rd);
						this.visit(n.e2);
						if(n.b == Binop.Bdiv || n.b == Binop.Bsub) {
							Label L5 = new Label();
							current_graph.graph.put(L3, new Rmbinop(m, rd, r2, L5));
							current_graph.graph.put(L5, new Rmbinop(Mbinop.Mmov, r2, rd, Ld));
						}
